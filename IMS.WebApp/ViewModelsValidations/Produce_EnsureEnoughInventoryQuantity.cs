        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
             ...
             && produceViewModel.Product.ProductInventories != null)
            {
                foreach (var pi in produceViewModel.Product.ProductInventories)
                {
                    ...
                    {
                        return new ValidationResult($"The inventory ({pi.Inventory.InventoryName}) is not enought to produce {produceViewModel.QuantityToProduce} {produceViewModel.Product.ProductName}(s)",
